...
class SRData(data.Dataset):
        ...
        if args.ext.find('bin') >= 0:
            ...
            if args.ext.find('img') >= 0 or benchmark:
                ...
                for h in list_hr:
                    ...
                    self._check_and_load_sep(args.ext, h, b, verbose=True)
                ...
                for i, ll in enumerate(list_lr):
                    for l in ll:
                        ...
                        self._check_and_load_sep(args.ext, l, b, verbose=True)
    ...
    def _check_and_load_sep(self, ext, img, f, verbose=True):
